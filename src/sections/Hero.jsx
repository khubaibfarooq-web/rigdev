...
const Hero = () => {
    return (
        <section id="hero" className="bg-white pt-[160px] pb-[120px]">
            <div className="container flex flex-col-reverse md:flex-row items-center px-3 mx-auto space-y-0 md:space-y-0 md:px-6">
